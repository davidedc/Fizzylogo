...
(function() {
  ...
  FLObjects = (function() {
    ...
    FLObjects.prototype.findSignatureBindParamsAndMakeCall = function*(methodInvocationToBeChecked, theContext) {
      ...
      log("evaluation " + indentation() + "  I am: " + this.value);
  ...
  FLListClass = (function(superClass) {
    ...
    FLListClass.prototype.createNew = function() {
      ...
      toBeReturned.evaluatedElementsList = function(context) {
        ...
        for (i = j = 0, ref = this.length(); 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
          log("toBeReturned.evaluatedElementsList evaluating " + (this.elementAt(i)).flToString());
  ...
  initBootClasses = function() {
    ...
    FLTurtle.addMethod(flTokenize("home"), function*(context) {
      ...
      if (typeof canvasOutputElement !== "undefined" && canvasOutputElement !== null) {
        this.x = canvasOutputElement.width / 2;
        this.y = canvasOutputElement.height / 2;
        this.direction = 0;
      }
      return this;
    });
  ...
  Fizzylogo.init = function(textOutElem, canvasOutElem) {
    if (textOutElem != null) {
      log = function() {};
      dir = function() {};
    }
