...
(function() {
  var BaseDivideFunction, BaseFloorDivisionFunction, BaseMinusFunction, BaseMultiplyFunction, BasePercentFunction, BasePlusFunction, DEBUG_STRINGIFICATION_CHECKS, FLAccessUpperContext, FLAccessUpperContextClass, FLBoolean, FLBooleanClass, FLBreak, FLBreakClass, FLClass, FLClassClass, FLClasses, FLConsole, FLConsoleClass, FLContext, FLDone, FLDoneClass, FLEvaluationsCounter, FLEvaluationsCounterClass, FLException, FLExceptionClass, FLFakeCatch, FLFakeCatchClass, FLFakeElse, FLFakeElseClass, FLFor, FLForClass, FLForever, FLForeverClass, FLIfFallThrough, FLIfFallThroughClass, FLIfThen, FLIfThenClass, FLIn, FLInClass, FLList, FLListClass, FLNil, FLNilClass, FLNot, FLNotClass, FLNumber, FLNumberClass, FLObjects, FLPause, FLPauseClass, FLQuote, FLQuoteClass, FLRepeat1, FLRepeat1Class, FLRepeat2, FLRepeat2Class, FLReturn, FLReturnClass, FLString, FLStringClass, FLThrow, FLThrowClass, FLTo, FLToClass, FLToken, FLTokenClass, FLTry, FLTryClass, FLWorkspace, FLWorkspaceClass, StringFromValidID, ValidIDfromString, addDefaultMethods, allClasses, commonClassCreationFunction, commonSimpleValueEqualityFunction, commonSimpleValueInequalityFunction, eachClass, flTokenize, indentation, injectStrings, j, keyStr, len, linearize, outerMostContext, pauseFunctionContinuation, removeComments, removeStrings, repeatFunctionContinuation, sortFirstArrayAccordingToSecond, stringsTable_TO_CHECK_CONVERTIONS, tokenizeCommand,
  ...
  (typeof exports !== "undefined" && exports !== null ? exports : this).flTokenize = flTokenize;
  ...
  FLObjects = (function() {
    ...
    FLObjects.prototype.findSignatureBindParamsAndMakeCall = function(methodInvocationToBeChecked, theContext) {
      ...
      for (eachSignatureIndex = j = 0, ref = classContainingMethods.msgPatterns.length; 0 <= ref ? j < ref : j > ref; eachSignatureIndex = 0 <= ref ? ++j : --j) {
        ...
        while (!(eachSignature.isEmpty() || methodInvocation.isEmpty())) {
          ...
          if (eachElementOfSignature.flClass === FLToken) {
            ...
            if (eachElementOfSignature.isEvaluatingParam()) {
              ...
              ref3 = methodInvocation.partialEvalAsMessage(theContext, methodInvocation), returnedContext = ref3[0], methodInvocation = ref3[1];
        ...
        if (eachSignature.isEmpty() && soFarEverythingMatched) {
          ...
          contextToBeReturned = this.methodCall(classContainingMethods.methodBodies[eachSignatureIndex], newContext);
    ...
    FLObjects.prototype.methodCall = function(methodBody, theContext) {
      ...
      if (methodBody.flClass === FLList) {
        ...
        theContext.returned = methodBody.call(this, theContext);
      }
  ...
  FLListClass = (function(superClass) {
    ...
    FLListClass.prototype.createNew = function() {
        ...
        for (i = j = 0, ref = this.length(); 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
          ...
          if ((this.elementAt(i)).flClass === FLList) {
            ...
            if ((this.elementAt(i)).flClass === FLToken && (this.elementAt(i)).value === "self") {
              ...
              evalled = (this.elementAt(i))["eval"](context, this);
      ...
      toBeReturned.findReceiver = function(theContext) {
        ...
        ref = this.evalFirstListElementAndTurnRestIntoMessage(theContext), returnedContext = ref[0], restOfMessage = ref[1];
      ...
      toBeReturned["eval"] = function(theContext) {
        ...
        ref = this.partialEvalAsMessage(theContext), returnedContext = ref[0], returnedMessage = ref[1];
        ...
        for (j = 0, len = statements.length; j < len; j++) {
          ...
          while (true) {
            ...
            if (findAnotherReceiver) {
              ...
              ref = restOfMessage.findReceiver(returnedContext), returnedContext = ref[0], restOfMessage = ref[1], receiver = ref[2];
            ...
            if ((receiver.flClass === FLNumber || receiver.flClass === FLString || receiver.flClass === FLBoolean) && restOfMessage.isEmpty()) {
              ...
              ref1 = receiver.findSignatureBindParamsAndMakeCall(restOfMessage, theContext), returnedContext = ref1[0], returnedMessage = ref1[1];
            }
  ...
  (typeof exports !== "undefined" && exports !== null ? exports : this).FLList = FLList;
  ...
  FLToken.addMethod(flTokenize("= Class new"), function(context) {
    var toBeReturned;
    toBeReturned = commonClassCreationFunction(context, this.value, this.value);
    return toBeReturned;
  });
  ...
  FLToken.addMethod(flTokenize("= Class new named (theName)"), function(context) {
    ...
    toBeReturned = commonClassCreationFunction(context, this.value, theName.value);
    return toBeReturned;
  });
  ...
  FLFor.addMethod(flTokenize("each ( ' variable ) in: ( 'theList ) do: ( 'code )"), function(context) {
