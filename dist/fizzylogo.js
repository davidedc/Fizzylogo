...
(function() {
  ...
  initBootClasses = function() {
    ...
    FLBoolean.addMethod(flTokenize("⇒ ( ' trueBranch )"), function*(context) {
      ...
      log("FLBoolean ⇒ , predicate value is: " + this.value);
      if (this.value) {
