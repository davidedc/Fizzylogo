...
(function() {
  ...
  FLObjects = (function() {
    ...
    FLObjects.prototype.findSignatureBindParamsAndMakeCall = function*(methodInvocationToBeChecked, theContext, previousPriority, previousAssociativity, previousReceiver, previousSignature) {
      var classContainingMethods, contextToBeReturned, eachAssociativity, eachElementOfInvocation, eachElementOfSignature, eachPriority, eachSignature, eachSignatureIndex, goodMatchSoFar, j, methodInvocation, newContext, originalMethodInvocationStart, paramToken, ref, ref1, ref2, ref3, ref4, returnedContext, valueToBeBound;
      ...
      for (eachSignatureIndex = j = 0, ref = classContainingMethods.msgPatterns.length; 0 <= ref ? j < ref : j > ref; eachSignatureIndex = 0 <= ref ? ++j : --j) {
        ...
        if ((previousPriority != null) && (eachPriority != null)) {
          if (previousPriority < eachPriority) {
            ...
            if (eachAssociativity !== ASSOCIATIVITY_RIGHT_TO_LEFT || previousReceiver.flClass !== this.flClass || eachSignature.flToString() !== previousSignature.flToString()) {
              goodMatchSoFar = false;
            }
          }
        }
          ...
          while (!(eachSignature.isEmpty() || methodInvocation.isEmpty())) {
            ...
            if (eachElementOfSignature.flClass === FLToken) {
              ...
              if (eachElementOfSignature.isEvaluatingParam()) {
                ...
                ref3 = (yield* methodInvocation.partialEvalAsMessage(theContext, eachPriority, eachAssociativity, this, classContainingMethods.msgPatterns[eachSignatureIndex])), returnedContext = ref3[0], methodInvocation = ref3[1];
  ...
  FLClasses = (function(superClass) {
    ...
    FLClasses.prototype.associativities = null;
    ...
    FLClasses.prototype.addMethod = function(signature, methodBody, priority, associativity) {
        ...
        for (j = 0, len = statements.length; j < len; j++) {
          ...
          while (true) {
            ...
            if ((receiver.flClass === FLNumber || receiver.flClass === FLString || receiver.flClass === FLBoolean) && restOfMessage.isEmpty()) {
              ...
              ref1 = (yield* receiver.findSignatureBindParamsAndMakeCall(restOfMessage, theContext, priority, associativity, theReceiver, theSignature)), returnedContext = ref1[0], returnedMessage = ref1[1];
            }
